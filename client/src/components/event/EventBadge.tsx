...
const HotEventBadge = () => {
  return (
    <CustomBadge className="border-red-600 bg-red-50 fill-red-600 py-1 text-red-600">
      <svg
        className="h-4 w-4"
        viewBox="0 0 56 56"
...
const PopularEventBadge = () => {
  return (
    <CustomBadge className="border-yellow-500 bg-yellow-50 fill-yellow-600 py-1 text-yellow-600">
      <svg
